...
public class TwitterApp extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//ハッシュタグ選択ボタンのセット
		hashB = (Button) findViewById(R.id.tlButton);
		hashB.setOnClickListener(new View.OnClickListener() {
			@Override
	...
	public void clickHash(){
		Intent intent = new Intent(TwitterApp.this, PopupActivity.class);
